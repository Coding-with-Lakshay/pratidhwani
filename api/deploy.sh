#!/usr/bin/env bash
# Deploys pratidhwani-api to Cloud Run in asia-south1.
...
#   GCP_PROJECT            e.g. dmjone
#   PB_ADMIN_SECRET_NAME   Secret Manager secret name (default: pratidhwani-pb-admin)
#
...
PB_ADMIN_SECRET_NAME="${PB_ADMIN_SECRET_NAME:-pratidhwani-pb-admin}"
PB_ADMIN_EMAIL="${PB_ADMIN_EMAIL:-admin@dmj.one}"
